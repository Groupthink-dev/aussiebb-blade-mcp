...
An http-enabled blade must never serve unauthenticated or on a non-loopback
interface. ``_require_secure_http`` is the gate; these pin both invariants.
"""
...
from aussiebb_blade_mcp import auth
from aussiebb_blade_mcp.server import _require_secure_http
